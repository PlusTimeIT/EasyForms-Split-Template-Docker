...
final class ComplexServer extends InputForm
{
    use Transformable;
    ...
    public function alerts(): array
    {
        return [
            Alert::make()
                ->setTrigger(AlertTriggers::FailedLoad)
                ->setColor('red')
                ->setBorder('top')
                ->setClosable(true)
                ->setTextStyle(true)
                ->setText('Form Failed! try something different')
                ->setIcon(
            ...
            Alert::make()
                ...
                ->setClosable(true)
                ->setTextStyle(true)
                ->setText('Whatever you did it worked! Success')
                ->setIcon(
                    Icon::make()->setIcon('mdi-checkmark')
                ),
        ];
    }
    ...
    public function buttons(): array
    {
        return [
            Button::make()
                ...
                ->setText('Register')
                ->setAppendIcon(
                    Icon::make()->setIcon('mdi-star')->setTooltip(
            ...
            Button::make()
                ...
                ->setText('Reset Form')
                ->setPrependIcon(
                    Icon::make()->setIcon('mdi-refresh')->setTooltip(
                        Tooltip::make()->setText('Reset the form fields')
                    )
                )
                ->setOrder(1),
        ];
    ...
    public function fields(): array
    {
        return [
            ...
            ColorPickerField::make()
                ...
                ->setPicker(
                    ColorPicker::make()->setMode(ColorPickerModes::Hexa)
                )
                ->setRules([
                    RuleItem::make()->setName('required')->setValue(true),
                ]),
    ...
    public static function process(request $request): ProcessResponse
    {
        ...
        return ProcessResponse::make()->success("Yes is worked!");
    }
}
